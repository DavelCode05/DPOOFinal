...
public class TablaRegistrosReporte2 extends DefaultTableModel{
	...
	public TablaRegistrosReporte2(){
		String [] columnas =  {"Fecha   ", "Nombre   ", "Carnet de Identidad    "," Hora de Entrada    ", "Hora de salida    "};
	...
	public void cargarInfo(ArrayList<Registro> registros)
	{
		for(int i=0; i < registros.size(); i++){
			...
			Object [] newR = new Object[]{registros.get(i).getFecha().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) , registros.get(i).getPersona().getNombre(), registros.get(i).getPersona().getNumeroIdentidad(), hora,
