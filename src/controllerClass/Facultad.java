...
public class Facultad {
	...
	private Facultad() {
		...
		personal.add(new Estudiante("Fernando Ortega Vives", "03210367050", 3, 32 )); //5
		...
		personal.add(new Estudiante("Lucía Romero Pérez", "04220367043", 2, 22 )); //10
		personal.add(new Estudiante("Alvaro Tamayo Portela", "05040766544",1, 12 )); //11
		personal.add(new Profesor("Yanelis Rodríguez Pérez", "80211234715", "MC", "Titular", "Doctor en Ciencias", TipoContrato.Determinado)); //12
		personal.add(new Estudiante("Mariana Torres Díaz", "05220367041", 1, 13 )); //13
		...
		personal.add(new Directivo("Laura Méndez Rodríguez", "92010498765", "Filosofía", "Instructor","Aspirante", TipoContrato.Determinado, CargoDirectivo.Secretaria_Docente, AreaDirectivo.Secretaria)); //16
		...
		personal.add(new Estudiante("Luis Alberto Benítez", "02210367046", 4, 42 )); //26
		...
		personal.add(new Estudiante("José Ángel Ramírez", "03210367044", 3, 31 )); //32
		personal.add(new Estudiante("Matías Herrera Peña", "05210367048", 1, 13 )); //33
		personal.add(new Estudiante("Diana Cabrera León", "02220367047", 4, 41 )); //34
		...
		personal.add(new Estudiante("Isabela Suárez Correa", "04220367049", 2, 21 )); //37
		...
		personal.add(new Estudiante("Marta Caridad", "04220387044", 2, 22 )); //45 
